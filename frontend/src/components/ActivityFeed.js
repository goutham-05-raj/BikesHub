...
const ActivityFeed = ({ items }) => {
    const defaultItems = [
        { color: 'green', text: <><strong>Royal Enfield Classic 350</strong> was booked by Rahul Kumar</>, time: '2 minutes ago' },
        ...
        { color: 'green', text: <><strong>New customer</strong> Priya Sharma registered</>, time: '2 hours ago' },
